...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> createReservation(@RequestBody Reservation reservation) {
        ...
        auditLogRepository.save(AuditLog.builder()
                ...
                .actorRole("PATIENT")
                .organizationName(saved.getMedicineName() != null ? saved.getMedicineName() : "Medicine Reservation")
                .organizationType("PATIENT")
                .performedBy(saved.getUserName() != null ? saved.getUserName() : "Normal User")
                .date(java.time.LocalDate.now().toString())
                .time("Now")
                .reason("Created 15-min QR reservation for " + saved.getTotalQuantity() + " units of " + saved.getMedicineName())
    ...
    public ResponseEntity<?> updateStatus(@PathVariable String id, @RequestParam String status) {
        ...
        auditLogRepository.save(AuditLog.builder()
                ...
                .date(java.time.LocalDate.now().toString())
                .time("Now")
                .reason("Reservation " + saved.getId() + " status updated from " + oldStatus + " to " + status)
